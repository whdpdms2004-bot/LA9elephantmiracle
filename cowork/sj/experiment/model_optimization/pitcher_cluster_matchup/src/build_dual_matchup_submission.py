...
DESTINATION = OUTPUT_DIR / "submit_011.zip"
...
def main():
    ...
    metadata["version"] = 6
    metadata["track"] = "success_reverse_matchup_robust"
    metadata["outer_blend"]["insight_weight"] = 0.600
    metadata["outer_blend"]["base_weight"] = 0.400
    ...
    metadata["reverse_matchup_correction"] = {
        "pitcher_lookup_file": "pitcher_lookup_2025.csv",
        "batter_lookup_file": "batter_lookup_2025.csv",
        "pair_table_file": "reverse_pair_table_2025.csv",
        "ridge_file": "reverse_ridge_correction.json",
        "correction_scale": 0.55,
    ...
    metadata["dual_matchup_validation"] = {
        ...
        "success_scale": 0.10,
        "reverse_scale": 0.55,
        "f23_delta_brier": -9.216857920824051e-06,
        "f24_delta_brier": -3.07526529973734e-05,
        "single_bss_2024": 796.8673960988104,
        "outer_insight_weight": 0.600,
        "outer_blend_bss_2024": 810.098163037376,
    }
    artifacts = {
    ...
    artifacts.update({
        ...
        FINAL_DIR / "reverse_pair_table_2025.csv",
        FINAL_DIR / "reverse_ridge_correction.json",
    })
    ...
    record = {
        ...
        "f24_delta_brier": -3.07526529973734e-05,
        "single_bss_2024": 796.8673960988104,
        "blend_bss_2024": 810.098163037376,
    }
    log_path = OUTPUT_DIR / "SUBMISSION_LOG.md"
    existing = log_path.read_text(encoding="utf-8")
    marker = "## 성공 상성 + 반대 방향 실패 상성 011"
    ...
    section = [
        ...
        "|---|---:|---:|---:|---:|---:|---:|---:|",
        f"| `{record['filename']}` | 0.10 | 0.55 | 0.600 | "
    ...
    manifest_path = WORK / "final" / "dual_matchup_submission_manifest.json"
